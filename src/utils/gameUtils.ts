/**
 * src/utils/gameUtils.ts: QuickBingo oyununda kart üretimi, kazanma kontrolü ve kazanan belirleme gibi yardımcı fonksiyonları içerir.
 * Oyunun temel mantığını ve kurallarını uygular. Kart numaralarının üretilmesi, kazanma koşullarının kontrolü gibi işlemleri gerçekleştirir.
 ...
 * 
 * @returns {Array|Boolean} Çeşitli yardımcı fonksiyonlar ve sonuçları
 */
