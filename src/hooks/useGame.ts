/**
 * src/hooks/useGame.ts: QuickBingo oyunu için özel React hook'u.
 * Bu hook oyun odasını dinler ve şu görevleri yerine getirir:
 * 1. Oyun durumunu (başlangıç, geri sayım, oynama, bitiş) takip eder.
 * 2. 5x5 boyutunda benzersiz numaralardan oluşan QuickBingo kartı oluşturur.
...
// BOARD_SIZE: QuickBingo kartının boyutu (5x5)
const BOARD_SIZE = 5;
// COUNTDOWN_DURATION: oyun başlangıcındaki geri sayım süresi (saniye)
const COUNTDOWN_DURATION = 3;
// MAX_NUMBER: QuickBingo kartındaki maksimum numara
const MAX_NUMBER = 90;

// useGame: QuickBingo oyunu için özel React hook'u
export function useGame() {
  ...
  // playerBoard: her oyuncu için oluşturulan 5x5 QuickBingo kartı matrisi
