/**
 * src/components/Game/NumberDraw.tsx: QuickBingo oyununda çekilen sayıları ve animasyonunu gösteren bileşen.
 * Çekilen sayıları görsel olarak düzenler ve son çekilen sayıyı vurgular.
 * Material UI bileşenleri ve animasyonlar kullanır.
 *
